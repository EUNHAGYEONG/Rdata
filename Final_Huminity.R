...
gyeyang1_Humidity <- rename(gyeyang1_Humidity8, Humidity = value.location.56_127.Start...20180401)
...
bupyeong4_Humidity$Humidity <- ifelse(bupyeong4_Humidity$Humidity == -1, NA, bupyeong_Humidity$Humidity)
